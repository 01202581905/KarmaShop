                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong id="quantityproduct">{{ count($products) }}</strong><strong class="card-title"> Product</strong><div style="display: inline-block;margin-left: 76%;cursor: pointer;font-weight: 600;    padding: 6px 24px;background-color: #66bb6a;border-radius: 5px;"><a style="color: #fff" href="{{ route('addnewproductvendor') }}">New Product</a></div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="tr-procduct product-{{ $product->id }}">
                                            ...
                                            <td><a  class="buttondelete" dataproduct="{{ $product->id }}" href="javascript:void(0)" style="color: #fff;background-color: #dc3545;padding: 5px 10px;border-radius: 5px;margin-right: 10px;">Delete</a>
                                                <a href="{{ route('updatemyproductvendor',$product->slug ) }}" style="color: #fff;background-color: #03a9f3;padding: 5px 10px;border-radius: 5px;">Update</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
        ...
        jQuery(document).ready(function(){
            ...
            jQuery('.buttondelete').click(function(){
                ...
                if( result )
                {
                    ...
                    jQuery.ajax({
                        url: '/Karma/vendor/deleteproduct',
                        type: 'POST',
                        dataType: 'json',
                        data: {
