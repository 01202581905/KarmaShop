...
<form action="{{ route('updatedetailproduct') }}" method="POST" class="form-horizontal" enctype="multipart/form-data" role="form">
    @csrf
    ...
    <script type="text/javascript">
        jQuery(document).ready(function(){
            ...
            jQuery('#categoryproduct').change(function(){
                ...
                jQuery.ajax({
                    url: '/Karma/serverkarma/selecttypes',
                    type: 'POST',
                    dataType: 'json',
                    data: {
